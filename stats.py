...
def corr_stats(df, schedule):
    ...
    avail_corr = df['availability'].corr(df['happiness'], method='pearson')
    skill_corr = df['skill'].corr(df['happiness'], method='pearson')
    exp_corr = df['experience'].corr(df['happiness'], method='pearson')
